...
public class RandomHistoryAdapter extends RecyclerView.Adapter<RandomHistoryAdapter.MyViewHolder>
{
    private List<HistoryData> list;
    private Context context;

    public RandomHistoryAdapter(List<HistoryData> list, Context context)
    {
        this.list = list;
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType)
    {
        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.item_history_random, parent, false);
